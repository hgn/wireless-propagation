...
\slidetitle{Friis Wavelength Influences}{Friis Wavelength Influences}
			\begin{figure}[ht]
			\centering
			\subfigure[\tiny{Frequency: 2.4 GHz}]{\includegraphics[scale=0.45]{images/friis24.pdf}}
			\subfigure[\tiny{Frequency: 5.0 GHz}]{\includegraphics[scale=0.45]{images/friis50.pdf}}
			\end{figure}
\end{slide}
